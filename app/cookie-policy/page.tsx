...
export const metadata: Metadata = { title: "Cookie Policy — PC Pick Hub", description: "Cookie Policy for PC Pick Hub (pcpickhub.com)." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h2>Contact</h2>
        <p>If you have questions about our cookie use, contact us at <a href="mailto:hello@pcpickhub.com">hello@pcpickhub.com</a>.</p>
      </div>
    </>
  );
}
