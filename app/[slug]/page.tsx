...
const CATEGORIES: { label: string; href: string }[] = [{"label":"🖥️ GPUs","href":"/category/gpu"},{"label":"⚙️ CPUs","href":"/category/cpu"},{"label":"🗄️ Motherboards","href":"/category/motherboards"},{"label":"🧠 RAM & Memory","href":"/category/ram"},{"label":"💾 SSDs & Storage","href":"/category/storage"},{"label":"❄️ CPU Coolers","href":"/category/cpu-coolers"},{"label":"🔌 Power Supplies","href":"/category/psu"},{"label":"🏠 PC Cases","href":"/category/pc-cases"},{"label":"🖥️ PC Monitors","href":"/category/monitors"},{"label":"⌨️ Keyboards & Mice","href":"/category/peripherals"},{"label":"📶 WiFi & Networking","href":"/category/networking"},{"label":"💻 Laptops","href":"/category/laptops"}];
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description: post.description || "",
      type: "article",
      url: `https://www.pcpickhub.com/${slug}`,
      siteName: "PC Pick Hub",
    ...
    alternates: { canonical: `https://www.pcpickhub.com/${slug}` },
  };
}
...
export default async function ArticlePage({ params }: Props) {
  ...
  const schema = JSON.stringify({
    ...
    url: `https://www.pcpickhub.com/${slug}`,
    mainEntityOfPage: { "@type": "WebPage", "@id": `https://www.pcpickhub.com/${slug}` },
    author: { "@type": "Organization", name: "PC Pick Hub", url: "https://www.pcpickhub.com" },
    publisher: {
      "@type": "Organization",
      name: "PC Pick Hub",
      url: "https://www.pcpickhub.com",
      logo: { "@type": "ImageObject", url: "https://www.pcpickhub.com/logo.png", width: 200, height: 60 }
    },
    keywords: post.keyword || "",
  });
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://www.pcpickhub.com" },
      ...(post.category ? [{ "@type": "ListItem", position: 2, name: post.category.replace(/-/g, " ").replace(/\b\w/g, (l: string) => l.toUpperCase()), item: `https://www.pcpickhub.com/category/${post.category}` }] : []),
      { "@type": "ListItem", position: post.category ? 3 : 2, name: post.title, item: `https://www.pcpickhub.com/${slug}` },
    ],
  });
    ...
    <>
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        :root{--bg:#060b0f;--surface:#111520;--border:#1e2535;--text:#e4e8f4;--muted:#7a82a0;--accent:#22d3ee;--radius:10px}
          ...
          <article className="article">
            ...
            <div className="author-box">
              ...
              <div className="author-info">
                <div className="author-name">PC Pick Hub Editorial Team</div>
