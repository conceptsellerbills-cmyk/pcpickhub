    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-bg { position: absolute; inset: 0; background: radial-gradient(ellipse 80% 60% at 50% -10%, rgba(59,130,246,0.18) 0%, transparent 70%), radial-gradient(ellipse 60% 40% at 80% 80%, rgba(139,92,246,0.12) 0%, transparent 60%); pointer-events: none; }
      ...
      <section className="hero">
        ...
        <div className="hero-badge">Build Smarter, Spend Less</div>
        <h1 dangerouslySetInnerHTML={{ __html: "Find Your Perfect<br />PC Build for Any Budget" }} />
        <p>Expert component reviews, complete build guides and price-to-performance rankings for gaming PCs, workstations and budget builds. Stop overpaying.</p>
        <div className="hero-ctas">
          <a href="/pc-build-guides" className="hero-cta-primary">Explore PC Builds →</a>
          <a href="/categories" className="hero-cta-secondary">Browse Categories →</a>
        </div>
        <div className="stats-bar">
          {([{"v":"300+","l":"Components Reviewed"},{"v":"100+","l":"Builds Published"},{"v":"85K+","l":"Monthly Readers"},{"v":"2025","l":"Current"}] as {v:string,l:string}[]).map((st) => (
      ...
      <div className="container">
        ...
        <section className="section" style={{ paddingBottom: 40 }}>
          ...
          <div className="trending-row">
            {([{"label":"RTX 5080 Review","hot":true,"href":"/rtx-5080-review"},{"label":"AMD vs Intel 2025","hot":true,"href":"/amd-vs-intel-2025"},{"label":"Best $800 Gaming PC","href":"/best-800-dollar-gaming-pc"},{"label":"PCIe 5.0 SSD Worth It?","hot":true,"href":"/pcie-5-ssd-review"},{"label":"Best Cheap GPU","href":"/best-budget-gpu"},{"label":"Mini-ITX Build Guide","href":"/mini-itx-build-guide"}] as {label:string,hot?:boolean,href:string}[]).map((t) => (
        ...
        <section className="section" style={{ paddingTop: 20 }}>
          ...
          <div className="section-header">
            <h2 className="section-title">Top PC Components Right Now</h2>
          </div>
          <div className="picks-grid">
            {([{"badge":"Best GPU","badgeType":"gold","icon":"🖼️","title":"RTX 4070 Ti Super","desc":"The best price-to-performance GPU for 1440p gaming — beats the 4080 in value by a wide margin.","rating":5,"href":"/rtx-4070-ti-super-review"},{"badge":"Best CPU","badgeType":"silver","icon":"🧠","title":"AMD Ryzen 7 9700X","desc":"Exceptional single-core performance and efficiency. The best all-rounder CPU for gaming and work.","rating":5,"href":"/ryzen-7-9700x-review"},{"badge":"Best SSD","badgeType":"bronze","icon":"💾","title":"Samsung 990 Pro NVMe","desc":"Blazing fast PCIe 4.0 speeds, proven reliability and the best 5-year warranty in the category.","rating":5,"href":"/samsung-990-pro-review"}] as {badge:string,badgeType:string,icon:string,title:string,desc:string,rating:number,href:string}[]).map((p, i) => (
        ...
        <section className="section">
          ...
          <div className="section-header">
            <h2 className="section-title">How We Review PC Components</h2>
          </div>
          <div className="how-grid">
            {([{"num":"01","title":"We Benchmark Extensively","desc":"Every GPU and CPU is benchmarked across 20+ games and 10+ productivity workloads at multiple resolutions."},{"num":"02","title":"We Test in Real Builds","desc":"Components are tested in complete systems — not just isolated benches — to catch compatibility issues."},{"num":"03","title":"You Build with Confidence","desc":"Our guides include full parts lists, compatibility checks and step-by-step assembly instructions."}] as {num:string,title:string,desc:string}[]).map((h) => (
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="category-grid">
            {([{"icon":"🎮","label":"Gaming PCs","desc":"1080p, 1440p & 4K builds","href":"/category/gaming-pcs"},{"icon":"💼","label":"Workstations","desc":"Video editing & 3D rendering","href":"/category/workstations"},{"icon":"💰","label":"Budget Builds","desc":"Best value under $500 & $800","href":"/category/budget-builds"},{"icon":"🧠","label":"CPUs","desc":"Intel vs AMD benchmarks","href":"/category/cpus"},{"icon":"🖼️","label":"GPUs","desc":"Graphics card rankings & deals","href":"/category/gpus"},{"icon":"💾","label":"Storage & RAM","desc":"SSDs, NVMe & memory picks","href":"/category/storage"}] as {icon:string,label:string,desc:string,href:string}[]).map((c) => (
        ...
        {featured && (
          <section className="section" style={{ paddingTop: 0 }}>
            ...
            <a href={`/${featured.slug}`} className="featured-card">
              <div className="featured-visual">🖥️</div>
              <div className="featured-content">
                <span className="featured-badge">⚙️ Featured Build</span>
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="section-header">
            <h2 className="section-title">Why Readers Trust PC Pick Hub</h2>
          </div>
          <div className="why-grid">
            {([{"icon":"📊","title":"Real Benchmarks","desc":"Every number in our reviews comes from our own testing hardware — no manufacturer-provided data."},{"icon":"🔧","title":"We Build the Systems","desc":"We physically assemble every build we recommend to verify compatibility and real-world performance."},{"icon":"💰","title":"Price Tracking","desc":"We monitor component prices and update recommendations when better deals appear."},{"icon":"🔮","title":"Future-Proofing Focus","desc":"We always consider platform longevity — so your build stays relevant for 3-5 years minimum."}] as {icon:string,title:string,desc:string}[]).map((w) => (
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="faq-list">
            {([{"q":"What is the best gaming PC build for $1000 in 2025?","a":"We recommend an AMD Ryzen 5 7600X paired with an RTX 4070 for a $1000 build that handles 1440p gaming excellently. Full parts list in our guide."},{"q":"Is AMD or Intel better for gaming in 2025?","a":"AMD Ryzen 9000 series offers the best performance per dollar for gaming. Intel Core Ultra 200K is competitive but runs hotter and costs more."},{"q":"How much RAM do I need for gaming?","a":"32GB DDR5 is the sweet spot in 2025. 16GB is still functional but limiting for modern AAA titles that frequently use 12-14GB."},{"q":"Is it worth building a PC instead of buying pre-built?","a":"Building yourself saves 15-25% and gives you better component quality. Pre-built is better if you value convenience and warranty simplicity."},{"q":"What GPU should I buy for 1440p gaming?","a":"The RTX 4070 Ti Super and RX 7900 GRE are the best value options for high-framerate 1440p gaming. Both handle 4K in demanding titles as well."}] as {q:string,a:string}[]).map((f) => (
        ...
        <div className="newsletter-section">
          <h2>Never Overpay for PC Parts Again</h2>
          <p>Get price drop alerts, new review notifications and complete build guides weekly.</p>
          <NewsletterForm />
        </div>

        {/* ── CTA ── */}
        <div className="cta-section">
          <h2>Build Your Dream PC for Less</h2>
          <p>Expert component picks, complete build guides and price alerts before you spend a single dollar.</p>
          <a href="/pc-build-guides" className="cta-btn">Browse PC Guides →</a>
        </div>
