...
export const metadata: Metadata = { title: "Write for Us — PC Pick Hub", description: "Contribute a guest post to PC Pick Hub. Share your expertise on tech and PC products." };
...
`}</style>
      <div className="page-wrap">
        ...
        <p className="page-subtitle">We welcome guest contributors who can bring original insights and expertise to our readers. If you know tech and PC products well, we'd love to publish your work.</p>
        <hr className="page-divider" />
        <h2>What We're Looking For</h2>
        <ul>
          <li>Original, well-researched articles on tech and PC products</li>
        ...
        <h2>How to Pitch</h2>
        <p>Email us at <a href="mailto:hello@pcpickhub.com">hello@pcpickhub.com</a> with the subject line "Guest Post Pitch" and include:</p>
        <ul>
