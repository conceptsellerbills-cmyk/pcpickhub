...
export const metadata: Metadata = { title: "Contact — PC Pick Hub", description: "Get in touch with the PC Pick Hub team." };
...
`}</style>
      <div className="page-wrap">
        ...
        <div className="info-card">
          ...
          <p>For faster responses, email us at <a href="mailto:hello@pcpickhub.com">hello@pcpickhub.com</a>. We reply within 1–2 business days.</p>
        </div>
