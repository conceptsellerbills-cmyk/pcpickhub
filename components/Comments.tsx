...
export function Comments({ title }: CommentsProps) {
  ...
  useEffect(() => {
    ...
    script.setAttribute("data-repo", "conceptsellerbills-cmyk/pcpickhub");
    script.setAttribute("data-repo-id", "R_kgDOR9IUhg");
    script.setAttribute("data-category", "General");
    script.setAttribute("data-category-id", "DIC_kwDOR9IUhs4C6gbr");
